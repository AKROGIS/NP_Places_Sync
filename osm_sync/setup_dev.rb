...
puts "http://api06.dev.openstreetmap.org/user/{{display_name}}/oauth_clients/new"
...
File.open('dev_auth.yaml', 'w') {|f| YAML.dump(auth, f)}
 
puts "Done. Have a look at dev_auth.yaml to see what's there."
