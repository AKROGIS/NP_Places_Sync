...
puts "http://www.openstreetmap.org/user/{{display_name}}/oauth_clients/new"
...
File.open('live_auth.yaml', 'w') {|f| YAML.dump(auth, f)}
 
puts "Done. Have a look at live_auth.yaml to see what's there."
